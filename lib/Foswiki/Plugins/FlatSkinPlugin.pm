...
<script src="$pluginURL/src/jasny-bootstrap/dist/js/jasny-bootstrap.min.js"></script>
<script src="$pluginURL/js/jquery.slimscroll.min.js"></script>
<script src="$pluginURL/js/comment.js"></script>
SCRIPT
